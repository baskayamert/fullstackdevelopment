...
describe('CityController', () => {
    ...
    beforeEach(async () => {
        ...
        cityServiceSpy = {
            ...
            getCitiesBySearchText: jest.fn(() => mockCitiesBySearchTextDto)
        } as any;
    ...
    it('GET Method for /cities should handle internal server error', async () => {
        ...
        jest.spyOn(cityServiceSpy, 'getCities').mockRejectedValue(null);
        expect(response.status).toHaveBeenCalledWith(HttpStatus.INTERNAL_SERVER_ERROR);
        expect(response.send).toHaveBeenCalledWith({
          message: API_RESPONSE_TEXTS.INTERNAL_ERROR,
          data: null,
    ...
    it('GET Method for /cities/:searchText should handle internal server error', async () => {
        ...
        jest.spyOn(cityServiceSpy, 'getCitiesBySearchText').mockRejectedValue(new Error("Something went wrong"));
        ...
        jest.spyOn(cityServiceSpy, 'getCitiesBySearchText').mockRejectedValue(null);
